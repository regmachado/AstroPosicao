...
\draw[thick, draw=none] (0,0,0) -- (-1, 0,0) node[below]{$L$}; % eixo -x
\draw[thick, draw=none] (0,0,0) -- ( 0, 1,0) node[right above]{}; % eixo  y
\draw[thick, draw=none] (0,0,0) -- ( 0,-1,0) node[left above]{}; % eixo -y
...
% eixo
\draw[very thick, -, tdplot_rotated_coords] (0,0,0) -- (0,0,1.2) node[above]{$PN$};

% eixo 
\draw[very thick, -, tdplot_rotated_coords] (0,0,0) -- (0,0,-1.2) node[above]{$PS$};
...
\tdplotdrawarc[thick, red,<-, tdplot_rotated_coords]{(0,0,\HC)}{\RC}{0-\eC}{180+\eC}{}{} %fudge
